...
**Word in this verse:** `صِدْقُهُمْ ۚ` — their truthfulness
...
**Word in this verse:** `صِدْقًۭا` — (in) truth
...
**Word in this verse:** `صِدْقٍ` — (will be) a respectable position
...
**Word in this verse:** `صِدْقٍۢ` — honorable
