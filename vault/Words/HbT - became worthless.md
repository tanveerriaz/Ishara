...
**Word in this verse:** `حَبِطَتْ` — became worthless
...
**Word in this verse:** `حَبِطَ` — (are) wasted
...
**Word in this verse:** `لَحَبِطَ` — surely (would be) worthless
...
**Word in this verse:** `حَبِطَتْ` — worthless
...
**Word in this verse:** `وَحَبِطَ` — And (has) gone in vain
...
**Word in this verse:** `فَحَبِطَتْ` — So (are) vain
