...
**Word in this verse:** `دَرَجَةٌۭ ۗ` — (is) a degree
...
**Word in this verse:** `دَرَجَـٰتٍۢ ۚ` — (in) degrees
...
**Word in this verse:** `دَرَجَـٰتٌ` — (are in varying) degrees
...
**Word in this verse:** `دَرَجَةًۭ ۚ` — (in) rank
...
**Word in this verse:** `دَرَجَـٰتٍۢ` — Ranks
...
**Word in this verse:** `دَرَجَـٰتٍۢ` — (by) degrees
...
**Word in this verse:** `دَرَجَـٰتٌۭ` — (will be) degrees
...
**Word in this verse:** `دَرَجَـٰتٍۢ` — (in) ranks
...
**Word in this verse:** `دَرَجَـٰتٌ` — (are) ranks
...
**Word in this verse:** `دَرَجَةً` — (in) rank
