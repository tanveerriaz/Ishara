...
**Word in this verse:** `ضَلَـٰلٍۢ` — (the) error
...
**Word in this verse:** `ضَلَـٰلًۢا` — astray 
...
**Word in this verse:** `ضَلَـٰلًۢا` — straying
...
**Word in this verse:** `ضَلَـٰلٍۢ` — error
...
**Word in this verse:** `ٱلضَّلَـٰلُ ۖ` — the error
...
**Word in this verse:** `ضَلَـٰلٍۢ` — an error
