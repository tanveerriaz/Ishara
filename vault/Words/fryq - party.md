...
**Word in this verse:** `فَرِيقٌۭ` — a party
...
**Word in this verse:** `فَرِيقًۭا` — a party
...
**Word in this verse:** `فَفَرِيقًۭا` — So a party
...
**Word in this verse:** `فَرِيقًۭا` — a group
...
**Word in this verse:** `فَرِيقًۭا` — a portion
...
**Word in this verse:** `لَفَرِيقًۭا` — surely (is) a group 
