...
**Word in this verse:** `ٱلسِّحْرَ` — [the] magic
...
**Word in this verse:** `سِحْرٌۭ` — magic
...
**Word in this verse:** `لَسِحْرٌۭ` — (is) surely, a magic
...
**Word in this verse:** `أَسِحْرٌ` — Is this magic
...
**Word in this verse:** `ٱلسِّحْرُ ۖ` — (is) the magic
...
**Word in this verse:** `سِحْرٌۭ` — a magic
