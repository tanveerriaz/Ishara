...
**Word in this verse:** `بُهْتَـٰنًۭا` — (by) slander
...
**Word in this verse:** `بُهْتَـٰنًۭا` — (with) a slander
...
**Word in this verse:** `بُهْتَـٰنًا` — a slander
...
**Word in this verse:** `بُهْتَـٰنٌ` — (is) a slander
...
**Word in this verse:** `بُهْتَـٰنًۭا` — false accusation
...
**Word in this verse:** `بِبُهْتَـٰنٍۢ` — slander
