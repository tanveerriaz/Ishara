...
**Word in this verse:** `أَمَدًۢا` — (was) a distance
...
**Word in this verse:** `أَمَدًۭا` — (in) time
...
**Word in this verse:** `ٱلْأَمَدُ` — the term
...
**Word in this verse:** `أَمَدًا` — a (distant) term
