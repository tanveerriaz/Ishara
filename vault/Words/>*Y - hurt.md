...
**Word in this verse:** `أَذًۭى` — an ailment
...
**Word in this verse:** `أَذًۭى` — (is) a hurt
...
**Word in this verse:** `أَذًۭى ۙ` — hurt 
...
**Word in this verse:** `أَذًۭى ۗ` — (by) hurt
...
**Word in this verse:** `وَٱلْأَذَىٰ` — or [the] hurt
...
**Word in this verse:** `أَذًۭى ۖ` — a hurt
...
**Word in this verse:** `أَذًۭى` — hurtful things
...
**Word in this verse:** `أَذًۭى` — any trouble
...
**Word in this verse:** `أَذَىٰهُمْ` — their harm
