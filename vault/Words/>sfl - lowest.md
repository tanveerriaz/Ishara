...
**Word in this verse:** `ٱلْأَسْفَلِ` — the lowest
...
**Word in this verse:** `أَسْفَلَ` — (was) lower
...
**Word in this verse:** `أَسْفَلَ` — below
...
**Word in this verse:** `ٱلْأَسْفَلِينَ` — the lowest
...
**Word in this verse:** `أَسْفَلَ` — (to the) lowest
