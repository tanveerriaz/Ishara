...
**Word in this verse:** `مِثْقَالَ` — (as much as) weight
...
**Word in this verse:** `مِّثْقَالِ` — (the) weight
...
**Word in this verse:** `مِثْقَالَ` — weight
...
**Word in this verse:** `مِثْقَالَ` — (the) weight
...
**Word in this verse:** `مِثْقَالُ` — (the) weight
...
**Word in this verse:** `مِثْقَالَ` — (equal to the) weight

**English (Sahih International):** So whoever does an atom's weight of good will see it,
