...
**Word in this verse:** `ٱلرُّشْدُ` — the right (path)
...
**Word in this verse:** `رُشْدًۭا` — sound judgement
...
**Word in this verse:** `ٱلرُّشْدِ` — (of) the righteousness
...
**Word in this verse:** `رَشَدًۭا` — (in the) right way
...
**Word in this verse:** `رَشَدًۭا` — right way
...
**Word in this verse:** `رُشْدًۭا` — (of) right guidance
...
**Word in this verse:** `رُشْدَهُۥ` — his guidance
...
**Word in this verse:** `ٱلرُّشْدِ` — the right way
...
**Word in this verse:** `رَشَدًۭا` — a right path
...
**Word in this verse:** `رَشَدًۭا` — (the) right path
