...
**Word in this verse:** `عَدَدَ` — (the) number
...
**Word in this verse:** `عَدَدًۭا` — a number
...
**Word in this verse:** `عَدَدَ` — (in) number
...
**Word in this verse:** `عَدَدًۭا` — (in) number
...
**Word in this verse:** `عَدَدًۢا` — (in) number
