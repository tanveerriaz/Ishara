...
**Word in this verse:** `ٱهْبِطُوا۟` — Go down (all of you)
...
**Word in this verse:** `ٱهْبِطُوا۟` — Go down
...
**Word in this verse:** `يَهْبِطُ` — fall down
...
**Word in this verse:** `فَٱهْبِطْ` — Then go down
...
**Word in this verse:** `ٱهْبِطُوا۟` — Get down
...
**Word in this verse:** `ٱهْبِطْ` — Go down
...
**Word in this verse:** `ٱهْبِطَا` — Go down
