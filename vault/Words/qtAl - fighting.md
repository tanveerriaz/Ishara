...
**Word in this verse:** `ٱلْقِتَالُ` — [the] fighting
...
**Word in this verse:** `قِتَالٍۢ` — (concerning) fighting
...
**Word in this verse:** `لِلْقِتَالِ ۗ` — for the battle
...
**Word in this verse:** `قِتَالًۭا` — fighting
...
**Word in this verse:** `لِّقِتَالٍ` — of war
...
**Word in this verse:** `ٱلْقِتَالِ ۚ` — [the] fight
...
**Word in this verse:** `ٱلْقِتَالَ ۚ` — (in) the battle
...
**Word in this verse:** `ٱلْقِتَالُ ۙ` — the fighting
