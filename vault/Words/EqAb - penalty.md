...
**Word in this verse:** `ٱلْعِقَابِ` — (in) retribution
...
**Word in this verse:** `ٱلْعِقَابِ` — in [the] chastising
...
**Word in this verse:** `ٱلْعِقَابِ` — (in) [the] punishment
...
**Word in this verse:** `ٱلْعِقَابِ` — (in) punishment
...
**Word in this verse:** `ٱلْعِقَابِ ۖ` — (in) the retribution
...
**Word in this verse:** `ٱلْعِقَابِ` — in [the] penalty
