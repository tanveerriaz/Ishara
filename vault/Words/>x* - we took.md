...
**Word in this verse:** `يُؤْخَذُ` — will be taken
...
**Word in this verse:** `فَأَخَذَتْكُمُ` — So seized you
...
**Word in this verse:** `أَخَذْنَا` — We took
...
**Word in this verse:** `أَخَذَتْهُ` — takes him
...
**Word in this verse:** `تَأْخُذُوا۟` — you take (back)
...
**Word in this verse:** `تَأْخُذُهُۥ` — overtakes Him
...
**Word in this verse:** `فَخُذْ` — Then take
