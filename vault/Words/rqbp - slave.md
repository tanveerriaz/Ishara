...
**Word in this verse:** `ٱلرِّقَابِ` — freeing the necks (slaves)
...
**Word in this verse:** `رَقَبَةٍۢ` — (of) a slave
...
**Word in this verse:** `رَقَبَةٍۢ ۖ` — a slave
...
**Word in this verse:** `ٱلرِّقَابِ` — the (freeing of) the necks
...
**Word in this verse:** `ٱلرِّقَابِ` — the necks
...
**Word in this verse:** `رَقَبَةٍ` — a neck
