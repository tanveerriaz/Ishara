...
**Word in this verse:** `مَسَـٰجِدَ` — (the) masajid
...
**Word in this verse:** `ٱلْمَسْجِدِ` — (of) Al-Masjid
...
**Word in this verse:** `ٱلْمَسَـٰجِدِ ۗ` — the masajid
...
**Word in this verse:** `ٱلْمَسْجِدِ` — Al-Masjid
...
**Word in this verse:** `ٱلْمَسْجِدِ` — (near) Al-Masjid
...
**Word in this verse:** `وَٱلْمَسْجِدِ` — and (preventing access to) Al-Masjid
...
**Word in this verse:** `مَسْجِدٍۢ` — masjid
