...
**Word in this verse:** `ٱلشُّحَّ ۚ` — (by) greed
...
**Word in this verse:** `أَشِحَّةً` — Miserly
...
**Word in this verse:** `شُحَّ` — (from) stinginess
...
**Word in this verse:** `شُحَّ` — (from the) greediness
