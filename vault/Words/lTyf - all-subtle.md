...
**Word in this verse:** `ٱللَّطِيفُ` — the All-Subtle
...
**Word in this verse:** `لَطِيفٌۭ` — (is) Most Subtle
...
**Word in this verse:** `لَطِيفٌ` — (is) surely Subtle
...
**Word in this verse:** `لَطِيفٌ` — (is) All-Subtle

**English (Sahih International):** [And Luqmān said], "O my son, indeed if it [i.e., a wrong] should be the weight of a mustard seed and should be within a rock or [anywhere] in the heavens or in the earth, Allāh will bring it forth. Indeed, Allāh is Subtle and Aware.
...
**Word in this verse:** `لَطِيفًا` — All-Subtle
...
**Word in this verse:** `لَطِيفٌۢ` — (is) Subtle
...
**Word in this verse:** `ٱللَّطِيفُ` — (is) the Subtle
