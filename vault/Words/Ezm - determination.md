...
**Word in this verse:** `عَزَمُوا۟` — they resolve
...
**Word in this verse:** `تَعْزِمُوا۟` — resolve (on)
...
**Word in this verse:** `عَزَمْتَ` — you have decided
...
**Word in this verse:** `عَزْمِ` — the matters
...
**Word in this verse:** `عَزْمًۭا` — determination
...
**Word in this verse:** `عَزْمِ` — the matters requiring determination

**English (Sahih International):** O my son, establish prayer, enjoin what is right, forbid what is wrong, and be patient over what befalls you. Indeed, [all] that is of the matters [requiring] resolve.
...
**Word in this verse:** `عَزْمِ` — matters of determination
...
**Word in this verse:** `ٱلْعَزْمِ` — those of determination
...
**Word in this verse:** `عَزَمَ` — (is) determined
