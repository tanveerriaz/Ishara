...
**Word in this verse:** `يَبْطِشُونَ` — (to) hold
...
**Word in this verse:** `بَطَشْتُم` — you seize
...
**Word in this verse:** `يَبْطِشَ` — strike
...
**Word in this verse:** `بَطْشًۭا` — (in) power
...
**Word in this verse:** `نَبْطِشُ` — We will seize
...
**Word in this verse:** `بَطْشَ` — (the) Grip
