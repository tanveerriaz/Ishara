...
**Word in this verse:** `ٱلصِّرَٰطَ` — (to) the path
...
**Word in this verse:** `صِرَٰطَ` — (The) path
...
**Word in this verse:** `صِرَٰطٍۢ` — a path
...
**Word in this verse:** `صِرَٰطٌۭ` — (is) the path
...
**Word in this verse:** `صِرَٰطًۭا` — (to the) way
...
**Word in this verse:** `صِرَٰطًۭا` — (on) a way
...
**Word in this verse:** `صِرَٰطٍۢ` — (the) way
