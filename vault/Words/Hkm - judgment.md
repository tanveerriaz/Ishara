...
**Word in this verse:** `يَحْكُمُ` — will judge
...
**Word in this verse:** `لِيَحْكُمَ` — to judge
...
**Word in this verse:** `لِيَحْكُمَ` — that (it should) arbitrate
...
**Word in this verse:** `فَأَحْكُمُ` — and I will judge
...
**Word in this verse:** `وَٱلْحُكْمَ` — and the wisdom
...
**Word in this verse:** `حَكَمًۭا` — an arbitrator
...
**Word in this verse:** `حَكَمْتُم` — you judge
...
**Word in this verse:** `لِتَحْكُمَ` — so that you may judge
...
**Word in this verse:** `يَحْكُمُ` — decrees
