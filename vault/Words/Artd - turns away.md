...
**Word in this verse:** `يَرْتَدِدْ` — turns away
...
**Word in this verse:** `تَرْتَدُّوا۟` — turn
...
**Word in this verse:** `يَرْتَدَّ` — turns back
...
**Word in this verse:** `فَٱرْتَدَّ` — then returned (his) sight
...
**Word in this verse:** `يَرْتَدُّ` — returning
...
**Word in this verse:** `فَٱرْتَدَّا` — So they returned
...
**Word in this verse:** `يَرْتَدَّ` — returns
...
**Word in this verse:** `ٱرْتَدُّوا۟` — return
