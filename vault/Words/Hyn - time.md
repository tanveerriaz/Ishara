...
**Word in this verse:** `حِينٍۢ` — a period
...
**Word in this verse:** `وَحِينَ` — and (the) time
...
**Word in this verse:** `حِينَ` — (at the) time (of making)
...
**Word in this verse:** `حِينٍۢ` — a time
...
**Word in this verse:** `حِينٍۭ` — time
