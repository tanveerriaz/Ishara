...
**Word in this verse:** `ٱلْحَقُّ` — (is) the truth
...
**Word in this verse:** `ٱلْحَقَّ` — the Truth
...
**Word in this verse:** `ٱلْحَقِّ ۗ` — [the] right
...
**Word in this verse:** `بِٱلْحَقِّ ۚ` — with the truth
...
**Word in this verse:** `ٱلْحَقُّ ۖ` — the truth
...
**Word in this verse:** `بِٱلْحَقِّ` — with the truth
...
**Word in this verse:** `حَقَّ` — (as it has the) right
