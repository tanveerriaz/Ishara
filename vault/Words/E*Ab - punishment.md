...
**Word in this verse:** `عَذَابٌ` — (is) a punishment
...
**Word in this verse:** `ٱلْعَذَابِ` — torment
...
**Word in this verse:** `ٱلْعَذَابِ ۗ` — punishment
...
**Word in this verse:** `ٱلْعَذَابُ` — the punishment
...
**Word in this verse:** `عَذَابٌۭ` — (is) a punishment
...
**Word in this verse:** `ٱلْعَذَابِ` — the punishment
...
**Word in this verse:** `عَذَابِ` — (the) punishment
