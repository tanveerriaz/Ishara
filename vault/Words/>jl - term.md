...
**Word in this verse:** `أَجَلَهُنَّ` — their (waiting) term
...
**Word in this verse:** `أَجَلَهُنَّ` — their (specified) term
...
**Word in this verse:** `أَجَلَهُۥ ۚ` — its end
...
**Word in this verse:** `أَجَلٍۢ` — a term
...
**Word in this verse:** `أَجَلًۭا ۖ` — a term 
...
**Word in this verse:** `أَجَلٌۭ` — (the) term
...
**Word in this verse:** `أَجَلَنَا` — our term
