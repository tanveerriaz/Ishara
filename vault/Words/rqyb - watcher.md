...
**Word in this verse:** `رَقِيبًۭا` — Ever-Watchful
...
**Word in this verse:** `ٱلرَّقِيبَ` — the Watcher
...
**Word in this verse:** `رَقِيبٌۭ` — a watcher
...
**Word in this verse:** `رَّقِيبًۭا` — an Observer
...
**Word in this verse:** `رَقِيبٌ` — (is) an observer
