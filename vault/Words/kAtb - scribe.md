...
**Word in this verse:** `كَاتِبٌۢ` — a scribe
...
**Word in this verse:** `كَاتِبًۭا` — a scribe
...
**Word in this verse:** `كَـٰتِبُونَ` — (are) Recorders
...
**Word in this verse:** `كَـٰتِبِينَ` — recording

**English (Sahih International):** Noble and recording;

**Urdu (Fatah Muhammad Jalandhari):** عالی قدر( تمہاری باتوں کے) لکھنے والے

[Open on Quran.com](https://quran.com/82/11)
