...
**Word in this verse:** `أَبَدًۢا` — ever
...
**Word in this verse:** `أَبَدًۭا ۖ` — forever
...
**Word in this verse:** `أَبَدًۭا ۚ` — forever
...
**Word in this verse:** `أَبَدًۭا` — ever
...
**Word in this verse:** `أَبَدًا ۚ` — forever

**English (Sahih International):** [They will be] abiding therein forever. Indeed, Allāh has with Him a great reward.

**English (Yusuf Ali):** They will dwell therein for ever. Verily in Allah's presence is a reward, the greatest (of all).

**Urdu (Fatah Muhammad Jalandhari):** (اور وہ) ان میں ابدالاآباد رہیں گے۔ کچھ شک نہیں کہ خدا کے ہاں بڑا صلہ (تیار) ہے

[Open on Quran.com](https://quran.com/9/22)
