...
**Word in this verse:** `مَوَٰقِيتُ` — (are) indicators of periods
...
**Word in this verse:** `مِيقَـٰتُ` — (the) set term
...
**Word in this verse:** `لِمِيقَـٰتِنَا` — to Our appointed place
...
**Word in this verse:** `لِّمِيقَـٰتِنَا ۖ` — for Our appointment
...
**Word in this verse:** `لِمِيقَـٰتِ` — for (the) appointment
...
**Word in this verse:** `مِيقَـٰتُهُمْ` — (is) an appointed term for them
...
**Word in this verse:** `مِيقَـٰتِ` — (the) appointment
...
**Word in this verse:** `مِيقَـٰتًۭا` — an appointed time
