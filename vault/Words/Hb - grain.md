...
**Word in this verse:** `كَحُبِّ` — as (they should) love
...
**Word in this verse:** `حُبِّهِۦ` — spite of his love (for it)
...
**Word in this verse:** `حُبُّ` — (is) love
...
**Word in this verse:** `ٱلْحَبِّ` — (of) the grain
...
**Word in this verse:** `حَبًّۭا` — grain 
...
**Word in this verse:** `حُبًّا ۖ` — (with) love
...
**English (Sahih International):** And a sign for them is the dead earth. We have brought it to life and brought forth from it grain, and from it they eat.
...
**Urdu (Fatah Muhammad Jalandhari):** اور ایک نشانی ان کے لئے زمین مردہ ہے کہ ہم نے اس کو زندہ کیا اور اس میں سے اناج اُگایا۔ پھر یہ اس میں سے کھاتے ہیں

[Open on Quran.com](https://quran.com/36/33)
...
**Word in this verse:** `حُبَّ` — (the) love
...
**Word in this verse:** `وَحَبَّ` — and grain
...
**Word in this verse:** `وَٱلْحَبُّ` — And the grain
