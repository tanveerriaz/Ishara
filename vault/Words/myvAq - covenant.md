...
**Word in this verse:** `مِيثَـٰقِهِۦ` — its ratification
...
**Word in this verse:** `مِيثَـٰقَكُمْ` — your covenant
...
**Word in this verse:** `مِيثَـٰقَ` — (the) covenant
...
**Word in this verse:** `مِيثَـٰقَ` — covenant
...
**Word in this verse:** `مِيثَـٰقَ` — a Covenant
...
**Word in this verse:** `مِّيثَـٰقًا` — covenant
...
**Word in this verse:** `مِّيثَـٰقٌ` — (is) a treaty
...
**Word in this verse:** `مِّيثَـٰقٌۭ` — (is) a treaty
