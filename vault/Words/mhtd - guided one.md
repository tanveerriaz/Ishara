...
**Word in this verse:** `ٱلْمُهْتَدِ ۖ` — the guided one
...
**Word in this verse:** `ٱلْمُهْتَدِ ۖ` — (is) the guided one
...
**Word in this verse:** `مُّهْتَدٍۢ ۖ` — (is) a guided one
