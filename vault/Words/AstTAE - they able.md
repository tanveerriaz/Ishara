...
**Word in this verse:** `ٱسْتَطَـٰعُوا۟ ۚ` — they are able
...
**Word in this verse:** `يَسْتَطِيعُونَ` — they are able
...
**Word in this verse:** `يَسْتَطِيعُ` — capable
...
**Word in this verse:** `ٱسْتَطَاعَ` — is able
...
**Word in this verse:** `يَسْتَطِعْ` — able to
...
**Word in this verse:** `يَسْتَطِيعُونَ` — are able to
...
**Word in this verse:** `تَسْتَطِيعُوٓا۟` — will you be able
...
**Word in this verse:** `يَسْتَطِيعُ` — able
...
**Word in this verse:** `ٱسْتَطَعْتَ` — you are able
