...
**Word in this verse:** `إِحْدَىٰهُمَا` — one of the two
...
**Word in this verse:** `إِحْدَىٰهُنَّ` — one of them
...
**Word in this verse:** `إِحْدَى` — one
...
**Word in this verse:** `إِحْدَىٰهُمَا` — one of the two women
...
**Word in this verse:** `إِحْدَىٰهُمَا` — one of them
...
**Word in this verse:** `إِحْدَى` — any
...
**Word in this verse:** `لَإِحْدَى` — (is) surely one
