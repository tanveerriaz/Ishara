...
**Word in this verse:** `حَصِيدًۭا` — a harvest clean-mown
...
**Word in this verse:** `وَحَصِيدٌۭ` — and (some) mown
...
**Word in this verse:** `حَصِيدًا` — reaped
...
**Word in this verse:** `ٱلْحَصِيدِ` — (for) the harvest
