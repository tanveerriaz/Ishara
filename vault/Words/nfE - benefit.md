...
**Word in this verse:** `نَّفْعِهِمَا ۗ` — (the) benefit of (the) two
...
**Word in this verse:** `نَفْعًۭا ۚ` — (in) benefit
...
**Word in this verse:** `نَفْعًۭا ۚ` — any benefit
...
**Word in this verse:** `نَفْعًۭا` — (to) benefit
