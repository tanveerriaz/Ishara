...
**Word in this verse:** `ٱلْتَقَتَا ۖ` — which met 
...
**Word in this verse:** `ٱلْتَقَى` — met
...
**Word in this verse:** `ٱلْتَقَى` — (when) met
...
**Word in this verse:** `ٱلْتَقَيْتُمْ` — you met 
...
**Word in this verse:** `فَٱلْتَقَى` — so met
...
**Word in this verse:** `يَلْتَقِيَانِ` — meeting
