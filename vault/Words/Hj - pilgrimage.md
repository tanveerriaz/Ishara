...
**Word in this verse:** `حَجَّ` — performs Hajj
...
**Word in this verse:** `وَٱلْحَجِّ ۗ` — and (for) the Hajj
...
**Word in this verse:** `ٱلْحَجَّ` — the Hajj
...
**Word in this verse:** `ٱلْحَجُّ` — (For) the Hajj
...
**Word in this verse:** `حِجُّ` — (is) pilgrimage
...
**Word in this verse:** `ٱلْحَجِّ` — (of) the greater Pilgrimage
...
**Word in this verse:** `بِٱلْحَجِّ` — [of] the Pilgrimage
