...
**Word in this verse:** `ٱلصِّيَامُ` — [the] fasting
...
**Word in this verse:** `ٱلصِّيَامِ` — (of) fasting
...
**Word in this verse:** `صِيَامٍ` — fasting
...
**Word in this verse:** `فَصِيَامُ` — then fasting
...
**Word in this verse:** `فَصِيَامُ` — (that), then fasting
...
**Word in this verse:** `صِيَامًۭا` — (in) fasting
