...
**Word in this verse:** `يُخْلِفَ` — will break
...
**Word in this verse:** `يُخْلِفُ` — break
...
**Word in this verse:** `تُخْلِفُ` — break
...
**Word in this verse:** `أَخْلَفُوا۟` — they broke
...
**Word in this verse:** `يُخْلِفُ` — fail
...
**Word in this verse:** `فَأَخْلَفْتُكُمْ ۖ` — but I betrayed you
...
**Word in this verse:** `نُخْلِفُهُۥ` — we will fail it
...
**Word in this verse:** `فَأَخْلَفْتُم` — so you broke
...
**Word in this verse:** `أَخْلَفْنَا` — we broke
...
**Word in this verse:** `تُخْلَفَهُۥ ۖ` — you will fail to (keep) it
