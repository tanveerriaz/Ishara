...
**Word in this verse:** `بِبَاسِطٍۢ` — stretch
...
**Word in this verse:** `بَاسِطُوٓا۟` — (are) stretching out
...
**Word in this verse:** `كَبَـٰسِطِ` — like one who stretches
...
**Word in this verse:** `بَـٰسِطٌۭ` — stretched
