...
**Word in this verse:** `بِإِذْنِ` — by (the) permission
...
**Word in this verse:** `بِإِذْنِ` — by permission
...
**Word in this verse:** `بِإِذْنِهِۦ ۗ` — with His permission
...
**Word in this verse:** `بِإِذْنِهِۦ ۖ` — by His permission
...
**Word in this verse:** `بِإِذْنِهِۦ ۚ` — by His permission
