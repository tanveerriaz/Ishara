...
**Word in this verse:** `ٱلسَّاعَةُ` — the Hour
...
**Word in this verse:** `سَاعَةًۭ ۖ` — an hour
...
**Word in this verse:** `ٱلسَّاعَةِ` — the Hour
...
**Word in this verse:** `سَاعَةِ` — (the) hour
...
**Word in this verse:** `سَاعَةًۭ` — an hour
...
**Word in this verse:** `ٱلسَّاعَةَ` — the Hour
