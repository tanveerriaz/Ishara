...
**Word in this verse:** `إِصْلَاحٌۭ` — Setting right (their affairs)
...
**Word in this verse:** `إِصْلَـٰحًۭا ۚ` — (for) reconciliation
...
**Word in this verse:** `إِصْلَـٰحًۭا` — reconciliation
...
**Word in this verse:** `إِصْلَـٰحٍۭ` — conciliation
...
**Word in this verse:** `إِصْلَـٰحِهَا` — its reformation
...
**Word in this verse:** `إِصْلَـٰحِهَا ۚ` — its reformation
...
**Word in this verse:** `ٱلْإِصْلَـٰحَ` — the reform
