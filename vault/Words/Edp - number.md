...
**Word in this verse:** `فَعِدَّةٌۭ` — then a prescribed number
...
**Word in this verse:** `فَعِدَّةٌۭ` — then prescribed number (should be made up)
...
**Word in this verse:** `عِدَّةَ` — (the) number
...
**Word in this verse:** `بِعِدَّتِهِم` — their number
...
**Word in this verse:** `عِدَّةٍۢ` — waiting period
...
**Word in this verse:** `لِعِدَّتِهِنَّ` — for their waiting period
...
**Word in this verse:** `فَعِدَّتُهُنَّ` — then their waiting period
...
**Word in this verse:** `عِدَّتَهُمْ` — their number
