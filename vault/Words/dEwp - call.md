...
**Word in this verse:** `دَعْوَةَ` — (to the) invocation
...
**Word in this verse:** `دَّعْوَتُكُمَا` — (the) invocation of both of you
...
**Word in this verse:** `دَعْوَةُ` — (is) supplication
...
**Word in this verse:** `دَعْوَتَكَ` — Your call
...
**Word in this verse:** `دَعْوَةًۭ` — (with) a call

**English (Sahih International):** And of His signs is that the heaven and earth stand [i.e., remain] by His command. Then when He calls you with a [single] call from the earth, immediately you will come forth.
...
**Word in this verse:** `دَعْوَةٌۭ` — a claim
