...
**Word in this verse:** `وَٰحِدَةًۭ` — single
...
**Word in this verse:** `وَٰحِدَةٍۢ` — single
...
**Word in this verse:** `فَوَٰحِدَةً` — then (marry) one
...
**Word in this verse:** `وَٰحِدَةًۭ` — (only) one
...
**Word in this verse:** `وَٰحِدَةًۭ ۚ` — single
...
**Word in this verse:** `وَٰحِدَةًۭ` — one
...
**Word in this verse:** `وَٰحِدَةًۭ ۖ` — one community
