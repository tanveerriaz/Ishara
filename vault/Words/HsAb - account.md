...
**Word in this verse:** `ٱلْحِسَابِ` — (in taking) account
...
**Word in this verse:** `حِسَابٍۢ` — measure
...
**Word in this verse:** `حِسَابٍ` — measure
...
**Word in this verse:** `ٱلْحِسَابِ` — (in taking) the account
...
**Word in this verse:** `حِسَابِهِم` — their account
...
**Word in this verse:** `وَٱلْحِسَابَ ۚ` — and the count (of time)
