...
**Word in this verse:** `ٱلْعُسْرَ` — [the] hardship
...
**Word in this verse:** `عُسْرًۭا` — (raising) difficulty
...
**Word in this verse:** `عُسْرٍۢ` — hardship
...
**Word in this verse:** `ٱلْعُسْرِ` — the hardship
