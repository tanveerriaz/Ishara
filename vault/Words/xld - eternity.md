...
**Word in this verse:** `ٱلْخُلْدِ` — the everlasting
...
**Word in this verse:** `ٱلْخُلْدِ` — (of) the Eternity
...
**Word in this verse:** `ٱلْخُلْدَ ۖ` — [the] immortality
...
**Word in this verse:** `ٱلْخُلْدِ` — (of) Eternity

**English (Sahih International):** Say, "Is that better or the Garden of Eternity which is promised to the righteous? It will be for them a reward and destination.
...
**Word in this verse:** `ٱلْخُلْدِ ۖ` — (of) the eternity
