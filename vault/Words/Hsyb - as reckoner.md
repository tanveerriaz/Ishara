...
**Word in this verse:** `حَسِيبًۭا` — (as) a Reckoner
...
**Word in this verse:** `حَسِيبًا` — an Accountant
...
**Word in this verse:** `حَسِيبًۭا` — (as) accountant
