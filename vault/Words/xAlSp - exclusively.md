...
**Word in this verse:** `خَالِصَةًۭ` — exclusively
...
**Word in this verse:** `خَالِصَةٌۭ` — (is) exclusively
...
**Word in this verse:** `خَالِصَةًۭ` — exclusively (for them)
...
**Word in this verse:** `خَالِصَةًۭ` — only
...
**Word in this verse:** `بِخَالِصَةٍۢ` — for an exclusive (quality)
