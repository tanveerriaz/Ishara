...
**Word in this verse:** `يُخَفَّفُ` — will be lightened
...
**Word in this verse:** `يُخَفِّفَ` — lighten
...
**Word in this verse:** `خَفَّفَ` — has (been) lightened
...
**Word in this verse:** `يُخَفَّفُ` — it will be lightened
...
**Word in this verse:** `يُخَفِّفْ` — (to) lighten
