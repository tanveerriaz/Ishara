...
**Word in this verse:** `نُّطْفَةٍۢ` — a minute quantity of semen
...
**Word in this verse:** `نُّطْفَةٍۢ` — a semen-drop
...
**Word in this verse:** `نُطْفَةًۭ` — (as) a semen-drop
...
**Word in this verse:** `ٱلنُّطْفَةَ` — the semen-drop
...
**Word in this verse:** `نُّطْفَةٍ` — a semen-drop
...
**Word in this verse:** `نُطْفَةًۭ` — a semen-drop
