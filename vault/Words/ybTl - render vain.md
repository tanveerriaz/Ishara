...
**Word in this verse:** `تُبْطِلُوا۟` — render in vain
...
**Word in this verse:** `وَيُبْطِلَ` — and prove false
...
**Word in this verse:** `سَيُبْطِلُهُۥٓ ۖ` — will nullify it
...
**Word in this verse:** `تُبْطِلُوٓا۟` — make vain
