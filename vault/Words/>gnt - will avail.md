...
**Word in this verse:** `تُغْنِىَ` — will avail
...
**Word in this verse:** `يُغْنِ` — will be enriched
...
**Word in this verse:** `تُغْنِ` — availed
...
**Word in this verse:** `يُغْنِيكُمُ` — Allah will enrich you
...
**Word in this verse:** `يُغْنِى` — avail
...
**Word in this verse:** `تُغْنِى` — will avail
...
**Word in this verse:** `أَغْنَتْ` — availed
...
**Word in this verse:** `أُغْنِى` — I can avail
