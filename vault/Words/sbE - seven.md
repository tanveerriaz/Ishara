...
**Word in this verse:** `سَبْعَ` — seven
...
**Word in this verse:** `سَبْعِينَ` — seventy
...
**Word in this verse:** `سَبْعِ` — (the) seven
...
**Word in this verse:** `سَبْعَ` — (for) seven
...
**Word in this verse:** `سَبْعٌۭ` — seven

**English (Sahih International):** Then will come after that seven difficult [years] which will consume what you advanced [i.e., saved] for them, except a little from which you will store.
...
**Word in this verse:** `سَبْعًۭا` — seven
...
**Word in this verse:** `ٱلسَّبْعُ` — the seven heavens
