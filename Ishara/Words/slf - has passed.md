...
**Word in this verse:** `سَلَفَ` — (has) passed
...
**Word in this verse:** `سَلَفَ ۚ` — passed before
...
**Word in this verse:** `سَلَفَ ۗ` — passed before
...
**Word in this verse:** `سَلَفَ ۚ` — (has) passed
...
**Word in this verse:** `سَلَفَ` — (is) past
