...
**Word in this verse:** `صَغِيرًا` — small
...
**Word in this verse:** `صَغِيرًۭا` — (when I was) small
...
**Word in this verse:** `صَغِيرٍۢ` — small

**English (Sahih International):** And every small and great [thing] is inscribed.

**Urdu (Fatah Muhammad Jalandhari):** (یعنی) ہر چھوٹا اور بڑا کام لکھ دیا گیا ہے

[Open on Quran.com](https://quran.com/54/53)
