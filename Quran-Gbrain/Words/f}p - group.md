...
**Word in this verse:** `فِئَةٍۢ` — a company
...
**Word in this verse:** `فِئَتَيْنِ` — (the) two hosts
...
**Word in this verse:** `فِئَتَيْنِ` — (you have become) two parties
...
**Word in this verse:** `فِئَةٍۢ` — a group
...
**Word in this verse:** `فِئَةًۭ` — a force
...
**Word in this verse:** `ٱلْفِئَتَانِ` — the two forces
...
**Word in this verse:** `فِئَةٌۭ` — a group
...
**Word in this verse:** `فِئَةٍۢ` — group
