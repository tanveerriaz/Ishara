...
**Word in this verse:** `غُرْفَةًۢ` — (in the) hollow
...
**Word in this verse:** `ٱلْغُرْفَةَ` — the Chamber
...
**Word in this verse:** `غُرَفًۭا` — lofty dwellings
...
**Word in this verse:** `غُرَفٌۭ` — (are) lofty mansions
