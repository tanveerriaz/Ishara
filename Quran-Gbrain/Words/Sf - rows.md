...
**Word in this verse:** `صَفًّۭا` — (in) rows
...
**Word in this verse:** `صَفًّۭا ۚ` — (in) a line
...
**Word in this verse:** `صَفًّۭا` — (in) a row
...
**Word in this verse:** `صَفًّۭا ۖ` — (in) rows
...
**Word in this verse:** `صَفًّۭا` — rank
