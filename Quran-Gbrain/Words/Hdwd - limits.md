...
**Word in this verse:** `حُدُودُ` — (are the) limits
...
**Word in this verse:** `حُدُودَ` — (the) limits
...
**Word in this verse:** `حُدُودَهُۥ` — His limits 
...
**Word in this verse:** `لِحُدُودِ` — (the) limits
