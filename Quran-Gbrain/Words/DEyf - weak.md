...
**Word in this verse:** `ضُعَفَآءُ` — (are) weak
...
**Word in this verse:** `ضَعِيفًا` — weak
...
**Word in this verse:** `ضَعِيفًۭا` — weak
...
**Word in this verse:** `ٱلضُّعَفَآءِ` — the weak
...
**Word in this verse:** `ضَعِيفًۭا ۖ` — weak
...
**Word in this verse:** `ٱلضُّعَفَـٰٓؤُا۟` — the weak
