...
**Word in this verse:** `ٱدْخُلُوا۟` — Enter
...
**Word in this verse:** `يَدْخُلَ` — will enter
...
**Word in this verse:** `يَدْخُلُوهَآ` — they enter them
...
**Word in this verse:** `تَدْخُلُوا۟` — you will enter
...
**Word in this verse:** `دَخَلَ` — entered
...
**Word in this verse:** `دَخَلَهُۥ` — enters it 
...
**Word in this verse:** `دَخَلْتُم` — you had relations
...
**Word in this verse:** `يَدْخُلُونَ` — will enter
